    ...
    <div class="wrapper vh-100">
      ...
      @csrf
        ...
        <div class="form-group">
            ...
            <input type="text" id="inputPassword" name="name" :value="old('name')" required autofocus autocomplete="name" class="form-control form-control-lg" placeholder="Name" required="">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="password"
            name="password_confirmation" required autocomplete="new-password" type="password" id="inputPassword" class="form-control form-control-lg" placeholder="Password" required="">
